<#
.SYNOPSIS
   Presentation on PowerShell and SQL for HP and LearnNowOnline by David Cobb
.DOWNLOAD LINK
   http://bitly.com/hp-ps-and-sql
.DESCRIPTION
...
function Present-PowerShellAndSQL
{
    ...
    Process
    {
        ...
        {
            Clear-Host
            Write-Host -ForegroundColor Yellow -Object "Hello HP! `nWelcome to SQL and PowerShell,`npresented for LearnNowOnline by David Cobb"
        }
    }
    End
    {
