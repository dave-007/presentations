...
Set-Location "C:\Users\david_000\Dropbox\Presentations\SQL and PowerShell"

#load needed function, let's us take PowerShell objects and represent them as Javascrip arrays
