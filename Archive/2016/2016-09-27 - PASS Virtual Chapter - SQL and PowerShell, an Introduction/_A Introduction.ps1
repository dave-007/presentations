<#
.SYNOPSIS
   Presentation on PowerShell and SQL for PASS DBA Virtual Chapter
   by David Cobb
.DESCRIPTION
...
.GOALS & OUTLINE
    Inspire you to start or continue your journey learning PowerShell 
    Provide guidance and resources to get started on the right foot
...
function Present-PowerShellAndSQL
{
    ...
    Process
    {
        ...
        {
            Clear-Host
            Write-Host -ForegroundColor Yellow -Object "Hello! `nWelcome to SQL and PowerShell,`npresented for PASS DBA Virtual Chapter by David Cobb"
        }
    }
    End
    {
