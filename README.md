...
- [[2018-02-10] Windows Containers on ACS Kubernetes (South Florida CodeCamp)](./presentations/2018/2018-02-10%20-%20South%20Florida%20CodeCamp%20-%20Windows%20Containers%20on%20ACS%20Kubernetes/) `kubernetes` `containers` `azure` `windows`
...
- [[2022-11-18] Advantages of Being an Azure Cloud Generalist (Greater Lansing User Group)](./presentations/2022/2022-11-18%20-%20GLUG%20-%20Advantages%20of%20Being%20an%20Azure%20Cloud%20Generalist/) `azure` `cloud` `career` `learning`
...
### SQL + PowerShell
- [[2016-02-20] SQL and PowerShell, an Introduction (South Florida Code Camp)](./presentations/2016/2016-02-20%20-%20South%20Florida%20Code%20Camp%20-%20SQL%20and%20PowerShell,%20an%20Introduction/) `sql-server` `powershell` `beginner` `smo`
- [[2016-03-29] SQL and PowerShell, an Introduction (HP)](./presentations/2016/2016-03-29%20-%20HP%20-%20SQL%20and%20PowerShell,%20an%20Introduction/) `sql-server` `powershell` `beginner` `smo`
- [[2016-04-07] SQL and PowerShell, an Introduction (LearnNowOnline)](./presentations/2016/2016-04-07%20-%20LearnNowOnline%20-%20SQL%20and%20PowerShell,%20an%20Introduction/) `sql-server` `powershell` `beginner` `smo`
- [[2016-09-27] SQL and PowerShell, an Introduction (PASS Virtual Chapter)](./presentations/2016/2016-09-27%20-%20PASS%20Virtual%20Chapter%20-%20SQL%20and%20PowerShell,%20an%20Introduction/) `sql-server` `powershell` `beginner` `smo`
- [[2017-08-19] SQL and PowerShell Tools (South Florida SQL Server User Group)](./presentations/2017/2017-08-19%20-%20South%20Florida%20SQL%20Server%20User%20Group%20-%20SQL%20and%20PowerShell%20Tools/) `sql-server` `powershell` `tools` `modules`

### PowerShell
- [[2012-09-19] PowerShell for the Bleeding Edge DBA (South Florida SQL Server User Group)](./presentations/2012/2012-09-19%20-%20South%20Florida%20SQL%20Server%20User%20Group%20-%20PowerShell%20for%20the%20Bleeding%20Edge%20DBA/) `powershell` `sql-server` `dba` `automation`
- [[2013-02-19] My First PowerShell Script (Florida PowerShell User Group)](./presentations/2013/2013-02-19%20-%20Florida%20PowerShell%20User%20Group%20-%20My%20First%20PowerShell%20Script/) `powershell` `beginner` `scripting`
- [[2014-09-01] Don't Fear the Shell (FlaDotNet User Group)](./presentations/2014/2014-09-01%20-%20FlaDotNet%20User%20Group%20-%20Don't%20Fear%20the%20Shell/) `powershell` `beginner` `hands-on`

### SQL Server
- [[2011-07-01] DIY Hyper-V Clustering and SQL Server (South Florida SQL Saturday)](./presentations/2011/2011-07-01%20-%20South%20Florida%20SQL%20Saturday%20-%20DIY%20Hyper-V%20Clustering%20and%20SQL%20Server/) `sql-server` `virtualization` `clustering`
- [[2012-08-29] Replication Troubleshooting Custom Class (Homnick Systems)](./presentations/2012/2012-08-29%20-%20Homnick%20Systems%20-%20Replication%20Troubleshooting%20Custom%20Class/) `sql-server` `replication` `troubleshooting`
- [[2015-06-12] Rolling Database Snapshots (South Florida SQL Saturday)](./presentations/2015/2015-06-12%20-%20South%20Florida%20SQL%20Saturday%20-%20Rolling%20Darabase%20Snapshots/) `sql-server` `database-snapshots` `automation`
...
- [2019](./presentations/2019/)
- [2020](./presentations/2020/)
- [2022](./presentations/2022/)
- [2024](./presentations/2024/)
- [2025](./presentations/2025/)
...
#### [[2011-07-01] DIY Hyper-V Clustering and SQL Server (South Florida SQL Saturday)](./presentations/2011/2011-07-01%20-%20South%20Florida%20SQL%20Saturday%20-%20DIY%20Hyper-V%20Clustering%20and%20SQL%20Server/)
...
#### [[2012-08-29] Replication Troubleshooting Custom Class (Homnick Systems)](./presentations/2012/2012-08-29%20-%20Homnick%20Systems%20-%20Replication%20Troubleshooting%20Custom%20Class/)
...
#### [[2012-09-19] PowerShell for the Bleeding Edge DBA (South Florida SQL Server User Group)](./presentations/2012/2012-09-19%20-%20South%20Florida%20SQL%20Server%20User%20Group%20-%20PowerShell%20for%20the%20Bleeding%20Edge%20DBA/)
...
#### [[2013-02-19] My First PowerShell Script (Florida PowerShell User Group)](./presentations/2013/2013-02-19%20-%20Florida%20PowerShell%20User%20Group%20-%20My%20First%20PowerShell%20Script/)
...
#### [[2014-09-01] Don't Fear the Shell (FlaDotNet User Group)](./presentations/2014/2014-09-01%20-%20FlaDotNet%20User%20Group%20-%20Don't%20Fear%20the%20Shell/)
...
#### [[2015-06-12] Rolling Database Snapshots (South Florida SQL Saturday)](./presentations/2015/2015-06-12%20-%20South%20Florida%20SQL%20Saturday%20-%20Rolling%20Darabase%20Snapshots/)
...
#### [[2016-02-20] SQL and PowerShell, an Introduction (South Florida Code Camp)](./presentations/2016/2016-02-20%20-%20South%20Florida%20Code%20Camp%20-%20SQL%20and%20PowerShell,%20an%20Introduction/)
...
#### [[2016-03-29] SQL and PowerShell, an Introduction (HP)](./presentations/2016/2016-03-29%20-%20HP%20-%20SQL%20and%20PowerShell,%20an%20Introduction/)
**Tags:** `sql-server` `powershell` `beginner` `smo`
...
#### [[2016-04-07] SQL and PowerShell, an Introduction (LearnNowOnline)](./presentations/2016/2016-04-07%20-%20LearnNowOnline%20-%20SQL%20and%20PowerShell,%20an%20Introduction/)
**Tags:** `sql-server` `powershell` `beginner` `smo`

Online learning version of the SQL and PowerShell introduction, including additional SQL treemap visualization script.

#### [[2016-09-27] SQL and PowerShell, an Introduction (PASS Virtual Chapter)](./presentations/2016/2016-09-27%20-%20PASS%20Virtual%20Chapter%20-%20SQL%20and%20PowerShell,%20an%20Introduction/)
...
#### [[2017-08-19] SQL and PowerShell Tools (South Florida SQL Server User Group)](./presentations/2017/2017-08-19%20-%20South%20Florida%20SQL%20Server%20User%20Group%20-%20SQL%20and%20PowerShell%20Tools/)
...
#### [[2018-02-10] Windows Containers on ACS Kubernetes (South Florida CodeCamp)](./presentations/2018/2018-02-10%20-%20South%20Florida%20CodeCamp%20-%20Windows%20Containers%20on%20ACS%20Kubernetes/)
...
#### [[2019-03-02] Take Command of AWS Command Line (South Florida CodeCamp)](./presentations/2019/2019-03-02%20-%20South%20Florida%20CodeCamp%20-%20Take%20Command%20of%20AWS%20Command%20Line/)
...
#### [[2020-01-09] Take Command of Azure PowerShell PowerShell 7 (MCSFUG)](./presentations/2020/2020-01-09%20-%20Take%20Command%20of%20Azure%20PowerShell%20PowerShell%207/)
...
#### [[2022-11-18] Advantages of Being an Azure Cloud Generalist (Greater Lansing User Group)](./presentations/2022/2022-11-18%20-%20GLUG%20-%20Advantages%20of%20Being%20an%20Azure%20Cloud%20Generalist/)
...
- Custom domain: [CNAME](CNAME) (currently `presentations.davidcobb.net`)
...
The current theme is set in [_config.yml](_config.yml) via `theme:`.
